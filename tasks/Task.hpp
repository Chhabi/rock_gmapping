...
#ifndef ROCK_GMAPPING_TASK_TASK_HPP
#define ROCK_GMAPPING_TASK_TASK_HPP

#include "rock_gmapping/TaskBase.hpp"
#include "../rock_gmappingTypes.hpp"
...
namespace rock_gmapping {
     ...
     * import_types_from "rock_gmapping/CustomType.hpp"
 ...
 tasks/Task.cpp, and will be put in the rock_gmapping namespace.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','rock_gmapping::Task')
     end
     \endverbatim
    ...
    protected:
        ...
        /* 
         */
        virtual ::rock_gmapping::OccupancyGrid getDynamicMap();
    ...
    public:
         ...
         */
        Task(std::string const& name = "rock_gmapping::Task");
